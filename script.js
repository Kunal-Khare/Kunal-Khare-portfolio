UnicornStudio.addScene({
    elementId: "kunalkhare", // id of the HTML element to render your scene in (the scene will use its dimensions)
    ...
    filePath: "./effect.json", // path to your effect json file
    interactivity: {
      // [optional]
      mouse: {
